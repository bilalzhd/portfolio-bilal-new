    ...
    <div className='bg-[#0a0a0a] text-white'>
      ...
      <div className='mb-32 container flex md:flex-row flex-col px-2 md:px-10 mt-[-10rem]'>
        ...
        <div className='text-center flex flex-col items-center py-16 px-8 border-2 border-bluish bg-[#141C3A]'>
          ...
          <Reveal userX={500} duration={1} delay={0.5} className="pb-8">
            ...
            <span className='text-bluish pb-8 text-lg'>UX, UI, Web, Apps</span>
          </Reveal>
          ...
          <ul className='text-bluish text-center text-lg'>
            ...
            <li>
              <Reveal userX={500} duration={1} delay={0.6}>
                C
              </Reveal>
            </li>
            <li>
            ...
            <li>
              <Reveal userX={500} duration={1} delay={0.9}>
                Github
              </Reveal>
            </li>
            <li>
              <Reveal userX={500} duration={1} delay={1}>
                SQL
              </Reveal>
            </li>
          </ul>
      ...
      <div className='container flex flex-col items-center pb-20'>
        <div className='flex md:flex-row flex-col md:space-x-10'>
          <Reveal userX={500} duration={0.5} delay={0}>
            <Image src="/work/oware.png" alt='Oware' height={350} width={350} className='rounded-2xl' />
          </Reveal>
          <Reveal userX={500} duration={0.75} delay={0.25}>
            <Image src="/work/oware.png" alt='Oware' height={350} width={350} className='rounded-2xl' />
          </Reveal>
          <Reveal userX={500} duration={0.5} delay={0.5}>
            <Image src="/work/oware.png" alt='Oware' height={350} width={350} className='rounded-2xl' />
          </Reveal>
        </div>
        <div className='flex md:flex-row flex-col justify-center md:space-x-10 mt-10 mb-20'>
          <Reveal userX={-500} duration={0.75} delay={0.75}>
            <Image src="/work/oware.png" alt='Oware' height={350} width={350} className='rounded-2xl' />
          </Reveal>
          <Reveal userX={-500} duration={1} delay={1}>
            <Image src="/work/oware.png" alt='Oware' height={350} width={350} className='rounded-2xl' />
          </Reveal>
          <Reveal userX={-500} duration={1.25} delay={1.25}>
            <Image src="/work/oware.png" alt='Oware' height={350} width={350} className='rounded-2xl' />
          </Reveal>
        </div>
